...
<div>
 ...
 <form method="post" enctype="multipart/form-data" style="text-align: center;">
  <center>
    <h2>Add Product</h2>
   <table border="1">
     <tr><td>Product Name</td><td><input type="text" name="pro" placeholder="Enter Disease"></td></tr>
     ...
     <tr><td colspan="2"><input type="submit" name="submit" value="Add" class="btn btn-primary"></td></tr>
   </table>
   </center>
 </form>  
...
if (isset($_POST['submit'])) {
  ...
  $folder = "image/".$name;
   ...
   $sql = mysqli_query($db,"INSERT INTO health_pro(product,disease,pic) VALUES ('$pro','$dis','$folder')");
   if ($sql) {

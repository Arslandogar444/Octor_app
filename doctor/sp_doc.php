...
<body>
	<div style="background-color: #0C2E80;"><a href="../index.php"><img src="logo.png"></a><font color="white"><h3 style="margin-left: 45%; margin-top: -3%;">Online Doctors</h3></font></div>
...
if (isset($_GET['doc'])) {
  ...
  $doc = "SELECT * FROM  doctor_profile WHERE specialty = '$dis'";
  $result = $db->query($doc);
  $num = $result->num_rows;
  if($num == 0){
